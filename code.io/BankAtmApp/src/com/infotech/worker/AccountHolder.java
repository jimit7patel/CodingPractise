package BankAtmApp.src.com.infotech.worker;

import BankAtmApp.src.com.infotech.model.Account;;
...
public class AccountHolder implements Runnable {
	...
	//if static method and make it static synchronized
	...
	private void makeWithdrawal2(int withdrawAmount) {
		if (account.getBalance() >= withdrawAmount) {
			System.out.println(Thread.currentThread().getName()	+ " is going to withdraw $"+withdrawAmount);
			try {
				Thread.sleep(3000);
